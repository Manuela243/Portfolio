...
[![portfolio.png][(https://i.postimg.cc/BvG1YYYS/registration-form.png)](https://postimg.cc/0zcQrf1F)](https://i.postimg.cc/mZ09tsS1/Snimka-zaslona-56.png)
...
2. That comments inside the code can be used to navigate through the code, and that they have a higher use than just being comment, they can tell others what is it in that section (used both in HTML, CSS and Javascript).0
3. Got introduced on how to use Responsive Web Deisgn.
